...
const Newsletter = () => {
  return (
    <section className="bg-[#EBEFE5] lg:mx-[50px] 2xl:mx-[300px] my-[50px] px-[25px] lg:px-[50px] py-[30px] lg:hidden ">
      <div>
      ...
      <div className="lg:flex items-start justify-between">
        ...
        <div>
          <form className="bg-white px-[20px] py-[10px] flex items-center justify-between  lg:w-[340px] rounded-[999px] ">
            <input
              type="email"
